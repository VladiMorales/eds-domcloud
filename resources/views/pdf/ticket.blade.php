    ...
    @foreach($boletos as $boleto)
        <div class="page-wrapper">
            ...
            <div id="vista-boleto" class="ticket-page">
                <div class="data-card">
                    <div class="data-row">
                        <div class="data-column data-column-left">
                        ...
                        <div class="data-column data-column-right">
                ...
                <div class="banner-container">
                    <img src="{{ pulic_path('img/boleto/horizontal_info.png') }}" alt="Banner Informativo" class="banner-img">
                </div>

                <div class="policy-container">
                    <div class="policy-title">Condiciones de Uso y Políticas - EDS Transport</div>
                    <p>
                        Políticas de Servicio y Condiciones de Uso del Boleto
                        Para cualquier aclaración, duda o solicitud relacionada con su viaje, ponemos a su
                        disposición nuestro servicio de atención a clientes al número 967 166 5525, donde con
                        gusto podremos brindarle asistencia. Asimismo, puede obtener información adicional
                        escaneando el código QR que se encuentra impreso en este boleto.
                        Este boleto es válido únicamente para la fecha, hora y servicio especificados en el
                        mismo, por lo que le recomendamos verificar cuidadosamente la información antes de
                        abordar. Para garantizar un proceso de embarque ágil y ordenado, se solicita a todos
                        los pasajeros presentarse en el punto de abordaje con al menos 15 minutos de
                        anticipación respecto a la hora programada de salida.
                        Al momento de abordar la unidad, el pasajero deberá presentar su boleto al personal
                        autorizado para su validación. El boleto es personal e intransferible, y su uso está
                        sujeto a las políticas y condiciones establecidas por la empresa.En caso de requerir
                        una modificación en su itinerario, este boleto permite realizar un cambio de fecha o de
                        horario, siempre y cuando la solicitud se realice con un mínimo de 2 horas de
                        anticipación respecto a la hora de salida originalmente seleccionada. Las
                        modificaciones estarán sujetas a disponibilidad en los servicios programados.
                        Para la seguridad y tranquilidad de nuestros pasajeros, este boleto incluye seguro de
                        viajero, el cual aplica conforme a los términos y condiciones establecidos por la póliza
                        correspondiente durante el trayecto.
                        En materia de comprobación fiscal, este boleto es canjeable por factura. El plazo para
                        solicitarla comprende todo el mes en el que se realizó el viaje y hasta los primeros dos
                        días naturales del mes siguiente. Para realizar su solicitud, deberá enviar por correo
                        electrónico sus datos fiscales completos, así como las especificaciones necesarias para
                        ...
                        ventas.enlacesds@outlook.es
                        Le agradecemos su preferencia y confianza. Nuestro compromiso es brindarle un
                        servicio seguro, puntual y de calidad en cada uno de sus viajes.
                    </p>
                </div>
            </div>
        </div>
